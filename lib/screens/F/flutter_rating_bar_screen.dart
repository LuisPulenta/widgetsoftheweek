...
class FlutterRatingBarScreen extends StatefulWidget {
  const FlutterRatingBarScreen({Key? key}) : super(key: key);

  @override
  State<FlutterRatingBarScreen> createState() => _FlutterRatingBarScreenState();
}

class _FlutterRatingBarScreenState extends State<FlutterRatingBarScreen> {
